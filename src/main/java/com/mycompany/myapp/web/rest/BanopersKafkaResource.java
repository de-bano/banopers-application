...
@RestController
@RequestMapping("/api/banopers-kafka")
public class BanopersKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BanopersKafkaResource.class);
    ...
    public BanopersKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
